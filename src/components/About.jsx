        ...
        <div className="flex flex-row justify-center pb-4">
            <div className="flex flex-col w-2/4 rounded-lg border-black bg-white text-center">
                ...
                <p className="pb-4 mx-4">
                    ...
                    backgrounds, which has given me a truly unique world view. I
                    am open to full stack web development and all the facets
                    that come with it, making use of MongoDB, Express.js,
                    React.js and Node.js. If you, or someone you know, happens
                    to know of a position that makes use of the various
                    technologies used in any of my portfolio pieces, please let
                    me know via LinkedIn or from my contact me page.
                </p>
            </div>
        </div>
    );
